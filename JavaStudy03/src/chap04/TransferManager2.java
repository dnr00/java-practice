...
// implementing of Lock Ordering
import chap04.AccountManager.CustomerAccount;

class TransferManager2 implements Runnable {
	
	private CustomerAccount fromAccount;
	private CustomerAccount toAccount;
	private int transferCount;
	
	public TransferManager2(CustomerAccount fromacct,
